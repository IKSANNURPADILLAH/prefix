...
IP_PREFIX="5.230.84"                 # Prefix dari subnet kamu
START=2                             # Awal range IP
END=62                               # Akhir range IP
EXCLUDE=(31 99)                   # IP akhir yang ingin dikecualikan, misal: 5.230.48.72, .80, .88
